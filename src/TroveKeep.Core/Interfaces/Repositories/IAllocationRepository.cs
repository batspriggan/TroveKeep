...
public interface IAllocationRepository
{
    ...
    /// <summary>Sets the quantity of an existing allocation (no-op if it does not exist).</summary>
    Task SetQuantityAsync(Guid itemId, Guid storageId, StorageType storageType, int quantity, int? storagePosition = null);
